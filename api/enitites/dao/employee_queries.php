...
class EmployeeQueries
{
    ...
    public function updateRow()
    {
        ...
        $query = 'UPDATE empleados 
                  ...
                  WHERE id_empleado = ?';
        $params = array($this->employee_name, $this->employee_lastname, $this->employee_dui, $this->employee_mail, $this->employee_phone, $this->employee_date, $adress, $this->employee_status, $this->employee_type, $this->employee_id);
        return Database::executeRow($query, $params);
    }
